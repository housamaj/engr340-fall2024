...
def calculate_average(data): # Function is used to calculate the average value of a list
...
def main(full_path_to_file):
    ...
    baseline_length = 600 ### your code here ###
    ...
    # RSI = (g*tf^2) / (8*tc)
    RSI = (g * math.pow(time_of_flight,2)) / (8 * time_of_contact)
